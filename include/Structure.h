...
struct Structure
{
    ...
    /** Update charge RMSE with this structure.
     *
     * @param[in,out] rmse Input RMSE to be updated.
     * @param[in,out] count Input counter to be updated.
     */
    void                     updateRmseCharge(double&      rmse,
                                              std::size_t& count) const;
    /** Update Dipole RMSE with  this structure.
     *
     * @param[in,out] rmse Input RMSE to be updated.
     * @param[in,out] count Input counter to be updated.
     */
    void                     updateRmseDipole(double      rmse[],
                                              std::size_t& count) const;
    /** Get reference and NN charge.
     *
     * @return String with #index, #chargeRef and #charge values.
     */
    std::string              getChargeLine() const;
    /** Get reference and Dipole.
     *
     * @return Vector of strings with force comparison.
     */
    std::string 	     getDipoleLine() const;
