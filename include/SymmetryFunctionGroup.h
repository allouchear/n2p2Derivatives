...
public:
    ...
    /** Calculate second derivatives of symmetry function on one atom.
     *
     * @param[in,out] atom Atom for which the symmetry function is caluclated.
     * @param[in] derivatives saved in
     */
    virtual void compute2Derivatives(Atom& atom, std::vector< std::vector<double> >& deriv) const = 0;
     ...
     */
    virtual void computeDerivatives(Atom& atom, Derivatives& deriv) const = 0;
#endif
