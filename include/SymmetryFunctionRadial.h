...
public:
     ...
     *
     * @param[in] atom Atom for which the derivatives of symmetry function are caluclated.
     * @param[out] deriv  contain the derivative of G by xx, xy, xz, yy, yz, zz coordinates of all atoms
     */
